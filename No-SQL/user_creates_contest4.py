...
user_embedded_2 = database["User_1_Embedded_2"]
...
for contest_info in user_4[0]["created_contests"]:
    ...
    print(
        f"""contest_id:{contest_info['contest_id']}, 
            group_id:{contest_info['group_id']}, 
            is_private:{contest_info['is_private']}, 
            startTime:{contest_info['startTime']}, 
            frozen_contest:{contest_info['frozen_contest']}, 
            contest_duration:{contest_info['contest_duration']}, 
